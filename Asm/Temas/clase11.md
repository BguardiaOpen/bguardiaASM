...
*   [Manejo de texto](#Texto)
    ...
    *   [Obtener un caracter de la pantalla](#getchar)
    *   [Colocar un caracter en la pantalla](#putchar)
*   [Manejo de gráficos](#Graficas)
    *   [Obtener un pixel de la pantalla](#getpixel)
    *   [Colocar un pixel en la pantalla](#putpixel)
...
*   AL = Número de [pagina](#Pagina) deseada
...
*   AH = [Atributo](#Atributo) de color del caracter bajo el cursor.
...
*   BH = Número de [página](#Pagina) (recuerden, hay un cursor para cada página)
*   BL = [Atributo](#Atributo) de color para el caracter
