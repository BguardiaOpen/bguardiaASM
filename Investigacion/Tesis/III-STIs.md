...
Finalmente, se explica la relación entre los Sistemas Tutores Inteligentes y las interfases Inteligentes, y se propone clasificar a los Asesores Inteligentes Automatizados como aquellos Sistemas Tutores Inteligentes que además son interfases Inteligentes.
...
Usa una interfase de línea de comandos, tradicional en la época en que se desarrolló, donde SCHOLAR le plantea preguntas al alumno sobre el tema; el alumno puede contestarlas, en cuyo caso el programa las evalúa y retroalimenta al alumno; pero además cuenta con un reloj, que usa para decidir avisar al estudiante que esté tardando demasiado. Sin embargo, lo que permite una retroalimentación inteligente es su capacidad de permitir que el estudiante tome iniciativa y haga preguntas; en ese caso, el programa es capaz de contestarlas, demostrando su razonamiento si es que no contaba con el hecho en su memoria; y de pedir al alumno que regrese a la pregunta anterior. Una de las fortalezas de SCHOLAR esté en su reconocimiento del lenguaje natural.
...
- Recientemente, se ha ampliado el uso de interfases más sofisticadas, que refuerzan la disponibilidad y facilidad de uso de los tutores inteligentes. Dos tendencias importantes en este sentido, son la utilización de multimedia y del WWW. [26] [43] [35] [38]
...
El concepto de asesores no es exclusivo de la enseñanza; es aplicable en otros ámbitos; sin embargo, en este trabajo, se usa el término 'asesores inteligentes' exclusivamente en referencia a este contexto. Cuando un sistema asesora al usuario sobre la forma de interactuar con una computadora, se dice que contamos con una _interface inteligente_. Por ello, se examinan a continuación algunos de los trabajos en el área de investigación sobre interfases inteligentes [6] [16] [17] [20] [31] [32] [33] [39] [40], así como las características de las mismas.

## 3.6 Interfases inteligentes

### 3.6.1 Problemática en el diseño de interfase

Schneiderman [6] resume los siguientes beneficios del estudio del diseño de Interfase Hombre - Máquina.
...
Existen diversas limitantes para conseguir estos beneficios; pero hay investigadores que han observado la oportunidad de mejorar una interfase, utilizando técnicas de Inteligencia Artificial. De acuerdo a los criterios de Schneiderman, esto se puede conseguir [6]:
...
#### Tabla 6: Clasificación de Sistemas Adaptativos según Benyon - Murray [20]
...
| Sistemas Adaptativos de Lenguaje Natural (NL)| Inferencia de necesidades y metas del usuario           | Facilitar la comprensión y generación del lenguaje natural, al ajustar el dominio al usuario particular |
| Tutores Inteligentes (ITS)                 | Capaces de reconocer errores y conceptos erróneos      | Enseñar conceptos al usuario estudiante (se asume la meta del usuario)          |

_Tabla 6: Clasificación de Sistemas Adaptativos según Benyon - Murray [20] (continúa)_

| Soporte Inteligente       | Incluyen las características de ITS; uso de lenguaje natural; orientados a la solución de problemas. | Ayuda activa, apoya al usuario en la ejecución de la tarea, no en su aprendizaje.                                                                 |
|---------------------------|--------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Agentes cooperativos inteligentes [9] [31] [40] | Sistemas independientes, que pudieran entrar en las Categorías anteriores; agregan elementos de trabajo en equipo y negociación. [12] | Mayor poder de resolución de problemas, en grupos. Conseguir la adaptación tanto respecto al exterior (humano) como interior (otro agente) |

En otras referencias, las interfases inteligentes se clasifican, de acuerdo a su estilo de ayuda, en: ayudas en línea inteligentes, interfases de comandos basadas en lenguaje natural; asistentes inteligentes; y asesores inteligentes:
...
De acuerdo a la clasificación de Benyon y Murray, las ayudas inteligentes serían el único tipo de interfases inteligentes 'puras'; las interfases de comandos con lenguaje natural pueden ser interfases inteligentes, sin entrar dentro de la clasificación de 'sistemas adaptativos de NL', dependiendo de si la 'adaptabilidad' se refiere al lenguaje o al reconocimiento de las acciones del usuario sobre el sistema. Los asistentes inteligentes están entre las interfases inteligentes, y los sistemas de soporte inteligente. Finalmente, los asesores inteligentes, tienen todas las características de una interfase inteligente, pero al mismo tiempo son Sistemas Tutores Inteligentes.

## 3.7. Asesores inteligentes

Contando con las características principales que distinguen a los Sistemas Tutores Inteligentes, así como a las interfases Inteligentes, se sugiere el nombre de "**Asesores Inteligentes**" para designar a los sistemas que cumplen con las características de ambas clases; de forma que, como se puede ver en la figura 10, a los Sistemas Tutores Inteligentes que siguen el paradigma de asesor, se les puede denotar como 'Asesores Inteligentes', y en el caso de que el dominio que el estudiante busca aprender sea el de la programación, hablaremos de 'Asesores Inteligentes aplicados a la enseñanza de la programación'.

![](III-STIs_files/image006.gif)
